...
var color = function () {
  ...
  var setColor = function setColor() {
    ...
    if (picker.active) {
      style.setProperty("--colorContent", "rgba(".concat(picker.pixel[0], ",").concat(picker.pixel[1], ",").concat(picker.pixel[2], ",").concat(picker.pixel[3], ")"));
    }
  };
...
/******/ })()
;
//# sourceMappingURL=bundle22163af18659e01c752f.js.map